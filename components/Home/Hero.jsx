      ...
      <section className="w-full relative flex underline-none flex-col  relative bg-primary-500 mt-0">
        ...
        <div className="md:flex-row flex flex-col w-full justify-between gap-10 md:mt-28 relative object-contain">
          <div className="md:text-left  pt-10 md:pt-20 w-full">
            <h1 className="font-bold text-primary  text-3xl md:text-7xl">AI Virtual</h1>
            <h1 className="font-bold text-primary text-3xl md:text-7xl flex">
              Assistant for
            </h1>
            <h1 className="font-bold text-primary text-3xl md:text-7xl flex">
              Psychotherapists
            ...
            <div class="flex justify-start pt-4 mb-10 gap-[10px] w-full">
              <a href="" class="flex px-[20px] gap-2 border-2 justify-center items-center h-fit rounded-lg shadow-inner py-2 md:text-[12px] text-[10px] bg-black text-white" role="button">
                ...
                <div className="leading-3">
                  <p>Get it on</p>
                  <h4 className="font-bold text-2xl">Google Play</h4>
                </div>
              </a>
              ...
              <a href="" className="flex px-[20px] gap-2 border-2 justify-center border-black items-center h-fit rounded-lg shadow-inner py-2 md:text-[12px] text-[10px]" role="button">
                ...
                <div data-aos="fade-up" className="leading-3">
                  <p>Download on</p>
                  <h4 className="font-bold text-2xl">Apple store</h4>
                </div>
              </a>
            </div>
          </div>
          <div className="w-full relative object-fit mx-auto flex justify-center">
            <Image src={'/images/slider-bg.png'} alt='logo' className='' height={600} width={600} priority={true} />

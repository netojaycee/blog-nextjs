...
const Features = () => {
    ...
    return (
        <section className="w-full relative flex flex-col  bg-primary-500 bg[url(/images/modal.png)] ">
            ...
            <div className="flex lg:flex-row flex-col-reverse lg:px-20 w-full lg:mt-20 mt-40 justify-between items-center py-10 relative gap-10 object-contain" >
                ...
                <div className="text-left space-y-8 w-full">
                    <h1 className="font-bold text-2xl lg:text-4xl text-center lg:text-left text-primary" data-aos="fade-left">
            ...
            <div className="grid lg:grid-cols-3 grid-cols-1 lg:px-20 py-8 gap-4 ">

...
const Features = () => {
    return (
        <section className="w-full relative flex flex-col  bg-primary-500 bg[url(/images/modal.png)] ">
            <Image src={"/images/section-bg.png"} height={700} width={700} className="object-cover w-[100%] h-[100%] md:mt-10 mt-20 hidden md:block rounded-xl md:absolute rounded-3xl" alt="man wearing glasses" />
            <div className="flex md:flex-row flex-col-reverse md:px-20 w-full md:mt-20 mt-40 justify-between items-center py-10 relative gap-10 object-contain">
                ...
                <div className="w-full object-fit ">
                    <Image src={"/images/modal.png"} height={700} width={700} className="object-cover rounded-3xl" alt="man wearing glasses" />
                </div>
            ...
            <div className="grid md:grid-cols-3 grid-cols-1 md:px-20 py-8 gap-4 ">
                <Card className='p-8 flex flex-col justify-start'>
